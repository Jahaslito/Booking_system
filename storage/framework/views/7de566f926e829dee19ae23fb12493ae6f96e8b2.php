			...
			<div class="m-2">
				...
				<table class="min-w-full divide-y divide-gray-200 box-border">
			          ...
			          <tbody class="bg-white divide-y divide-gray-200">
						<?php $__currentLoopData = $route; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $route): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<tr>
			              ...
			              <td class="px-6 py-4 whitespace-nowrap">
			                <div class="text-sm text-gray-900"><?php echo e($route->source); ?></div>
			              </td>
			              <td class="px-6 py-4 whitespace-nowrap">
			                <div class="text-sm text-gray-900"><?php echo e($route->destination); ?></div>
			              </td>
			              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
			                <?php echo e($route->price); ?>
...
</html><?php /**PATH C:\Users\Allan\Desktop\New folder\Booking_system\resources\views/adminviews/routes.blade.php ENDPATH**/ ?>
				...
				<table class="min-w-full divide-y divide-gray-200 box-border">
			          ...
			          <tbody class="bg-white divide-y divide-gray-200">
			            ...
			            <tr>
			              ...
			              <td class="px-6 py-4 whitespace-nowrap">
			                <div class="text-sm text-gray-900"><?php echo e($driver->name); ?></div>
			              </td>
			              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
			                <?php echo e($driver->phone_number); ?>

			              </td>
			              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
			                <?php echo e($driver->driver_licence); ?>
...
</html><?php /**PATH C:\Users\Allan\Desktop\New folder\Booking_system\resources\views/adminviews/drivers.blade.php ENDPATH**/ ?>